  ...
  <section id="about" class="about">
    <div class="h-card">
      ...
      <div class="bio">
        ...
        <p>Some of my most notable accomplishments include working on a Best in Show award-winning website, writing two novels (unpublished), interviewing a chart-topping musician, and writing hundreds of blog posts over the past six years.</p>
...
<style lang="sass">
  ...
  .trapezoid
    border-top: $shape-height solid $color-text-light
